...
public class MeetingPane extends ScheddarSubPane {
	...
	public MeetingPane(ScheddarPane s, Meeting m) {
		...
		//			System.out.println("Day of Month : " + date.get(Calendar.DAY_OF_MONTH));
					...
					ScheddarTime range = new ScheddarTime(from.get(Calendar.HOUR_OF_DAY),from.get(Calendar.MINUTE), difference.get(Calendar.MINUTE) + diffHours*60,date.get(Calendar.DAY_OF_WEEK)-1,date.get(Calendar.DAY_OF_MONTH)+1,date.get(Calendar.MONTH),date.get(Calendar.YEAR),false);
