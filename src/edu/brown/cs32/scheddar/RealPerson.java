...
public class RealPerson {
	...
	private HashMap<RealGroup,Double> groups; // a mapping of groups the person is in to their importance in that group
	...
	public Set<RealGroup> getGroups(){
		return this.groups.keySet();
	}
	
	public double getImportance(RealGroup g){
	...
	public void setGroups(HashMap<RealGroup,Double> newGroupHash){
	...
	public void addGroup(RealGroup group){
	...
	public void addGroupImportance(RealGroup group, double importance){
		this.groups.put(group, importance);
	}
	
	public void removeGroup(RealGroup group){
	...
	public void addGroupList(List<RealGroup> groupList){
		for(RealGroup g : groupList){
	...
	public void removeGroupList(List<RealGroup> groupList){
		for(RealGroup g : groupList){
